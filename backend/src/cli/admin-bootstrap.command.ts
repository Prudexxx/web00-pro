...
export interface AdminBootstrapCommandOptions {
  clock?: () => Date;
...
function createRepository(options: AdminBootstrapCommandOptions): {
...
if (isDirectRun()) {
  void runAdminBootstrapCommand().then((code) => {
