...
export interface CatalogAssetUrlResolution {
  source: "absolute" | "legacy";
  url: string;
}

export function resolveCatalogAssetUrl(value: unknown): CatalogAssetUrlResolution | null {
...
export function toCatalogAssetUrl(value: unknown): string | null {
  return resolveCatalogAssetUrl(value)?.url ?? null;
}

function resolveAbsoluteUrl(text: string): CatalogAssetUrlResolution | null {
...
function normalizeLegacyAssetPath(text: string): string | null {
...
function isSafeLegacyAssetPath(path: string): boolean {
