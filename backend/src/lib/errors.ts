export type ErrorCode =
  ...
  | "GITHUB_API_CONFLICT"
  | "GITHUB_API_FAILED"
  | "GITHUB_API_RETRYABLE"
  | "GITHUB_API_TIMEOUT"
  | "GITHUB_BRANCH_ALREADY_EXISTS"
  | "GITHUB_REPOSITORY_SETUP_REQUIRED"
  | "BACKEND_LIFECYCLE_FINALIZATION_FAILED"
  | "DIRECT_PAGES_PUBLICATION_REQUIRED"
  | "PAGES_DEPLOYMENT_NOT_VERIFIED"
  | "PAGES_DEPLOYMENT_FAILED"
  | "PULL_REQUEST_CLOSED"
  | "PULL_REQUEST_CONFLICTED"
  | "CATALOG_VALIDATION_FAILED"
  | "VERSION_CONFLICT"
  | "PUBLIC_CATALOG_V2_DISABLED"
